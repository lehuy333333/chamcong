...
@section('content')
            ...
            <div class="d-flex">
                <div class="mr-auto p-2">
                    <a class="btn btn-success nav-link btn-circle" href="#" data-toggle="modal"
                        data-target="#LevelFormModal" id="inserLeveltButton">
    ...
    <div class="modal fade bd-example-modal-lg" id="LevelFormModal" tabindex="-1" role="dialog" aria-labelledby="Thêm mới"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/level/create') }}" method="POST" id="LevelFormModal">
                    @csrf
                    <input type="hidden" name="id" value="" id="level_id" name="level_id">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="txtName">Chức Vụ</label>
                            <input type="text" class="form-control border border-danger"  id="txtName" name="level_name">
                        </div>
